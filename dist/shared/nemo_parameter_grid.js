...
class NemoParameterGrid {
    ...
    nemo_scanner_field_n_best(data, field) {
        let rfield = data.map((entry, index, array) => {
            ...
            return Object.assign({}, top_field, { TIME: entry.TIME, CH: entry.EARFCN, file: entry.file, LAT: entry.LAT, LON: entry.LON });
            ...
            return Object.assign({}, entry, { duplicate: index !== array.length - 1 ? array[index + 1].TIME == entry.TIME : false });
